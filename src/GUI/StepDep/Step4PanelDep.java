 ...
 * @author ltrask
 */
public class Step4PanelDep extends BorderPane {
    ...
    public Step4PanelDep(MainController control) {
        ...
        Label tempSummaryLabel = new Label("Step 4 Summary Panel Under Development");
