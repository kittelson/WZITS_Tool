...
public class Step6Panel extends BorderPane {
    ...
    public Step6Panel(MainController control) {
        ...
        Label startLabel = new Label("System Operation, Maintenance, and Evaluation");
        ...
        Label infoLabel = new Label("Step 6");
        ...
        pagination = new Pagination(Step2Table.getPageCount(5) + 2);
