...
//        allSubStepsPane.add(stepReportPane, i++, 0);
        ...
        this.subStepPanesList.add(sysPlansPane);
        this.subStepPanesList.add(schedulePane);
        this.subStepPanesList.add(acceptanceTrainingPane);
        this.subStepPanesList.add(deploymentIssuesPane);
