...
public class Step4TableHelper extends TableView {
    ...
    public static Node createStepSummary(MainController mc) {
        ...
        bPane.setTop(NodeFactory.createFormattedLabel("Fact Sheet #6: WZITS Procurement", "fact-sheet-title-large"));
        ...
        stepLists.add(p.getQGen().qDirectIndirectList);
        stepLists.add(p.getQGen().qMechanismList);
        stepLists.add(p.getQGen().qRFPList);
        stepLists.add(p.getQGen().qVendorSelectionList);
